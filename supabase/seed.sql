-- AgentStack Seed Data

-- Seed plan limits (stored as a reference table)
...
INSERT INTO public.plan_limits (plan, agents, workflows, executions_per_month, team_members, storage_gb, api_requests_per_day) VALUES
    ...
    ('enterprise', -1, -1, -1, -1, -1, -1)  -- -1 = unlimited
...
-- Seed agent templates (82 production templates)
\i seeds/agent_templates.sql
