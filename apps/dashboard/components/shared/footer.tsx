...
const footerLinks = {
  Product: [
    ...
    { label: "GitHub", href: "https://github.com/meek72911/Agent-Stack" },
  ],
  Company: [
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          <div className="md:col-span-1">
            ...
            <div className="mt-6 flex gap-4">
              <a href="https://github.com/meek72911/Agent-Stack" target="_blank" rel="noopener noreferrer" className="text-[#94A3B8] hover:text-[#F1F5F9] transition-colors duration-200">
