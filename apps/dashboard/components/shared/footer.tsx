...
export function Footer() {
  return (
    <footer className="border-t border-[#1C1F2E] bg-[#07080C]">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-[#94A3B8]">Scale your agency with AI workflows</p>
            <div className="mt-6 flex gap-4">
              <a href="https://github.com/Meek72vibe/agentstack" target="_blank" rel="noopener noreferrer" className="text-[#94A3B8] hover:text-[#F1F5F9]">
              ...
              <a href="https://linkedin.com/in/sarthak-khedkar-10a968242" target="_blank" rel="noopener noreferrer" className="text-[#94A3B8] hover:text-[#F1F5F9]">
