        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col items-start text-left">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.5 }} className="mt-6 flex items-center gap-2">
              <a href="https://github.com/meek72911/Agent-Stack" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 rounded-lg border border-[#1C1F2E] bg-[#0D0F17] px-3 py-1.5 text-sm text-[#94A3B8]">
                ...
                <Star className="h-4 w-4 fill-yellow-500 text-yellow-500" /><span>0</span><span>stars</span>
              </a>
            </motion.div>
          </div>
